...
Go
	CREATE OR ALTER VIEW onerosterv11.classes
		AS
		SELECT DISTINCT
		...
		GROUP BY	EDO.educationorganizationid ,SEC.Id,EDO.nameofinstitution , SEC.LastModifiedDate, SEC.LocalCourseCode, SEC.SequenceOfCourse, SEC.LocationClassroomIdentificationCode, 
