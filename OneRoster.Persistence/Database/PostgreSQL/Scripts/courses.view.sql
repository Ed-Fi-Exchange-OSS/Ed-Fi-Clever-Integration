drop view if exists onerosterv11.courses;

CREATE VIEW onerosterv11.courses
AS
...
,COU.Id																											AS "sourcedId"
, 'active'																										AS status
, COU.LastModifiedDate::timestamp with time zone																AS "dateLastModified"
...
LEFT JOIN edfi.SchoolYearType SYT	ON COO.SchoolYear = SYT.SchoolYear
